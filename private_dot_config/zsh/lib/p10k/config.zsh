# Generated by Powerlevel10k configuration wizard on 2023-02-05 at 10:17 AWST.
...
() {
	...
	function my_git_formatter() {
		...
		(( VCS_STATUS_PUSH_COMMITS_AHEA	)) && res+="${clean}⇢${VCS_STATUS_PUSH_COMMITS_AHEAD}"
		# *42 if have stashes.
	...
	# P9K_WIFI_LINK_AUT		| authentication protocol such as "wpa2-psk" or "none"; empty if unknown
